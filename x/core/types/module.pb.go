...
// source: tokenchain/core/module/v1/module.proto
...
func init() {
	proto.RegisterType((*Module)(nil), "tokenchain.core.module.v1.Module")
}

func init() {
	proto.RegisterFile("tokenchain/core/module/v1/module.proto", fileDescriptor_b817e7afa70c36b1)
}
